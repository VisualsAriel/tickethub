    ...
    <div class="paquetes__grid">
        <div class="paquete">
            ...
            <ul class="paquete__lista">
                <li class="paquete__elemento">Acceso Virtual a un evento de TicketHub</li>
            </ul>
        ...
        <div class="paquete">
            ...
            <ul class="paquete__lista">
                <li class="paquete__elemento">Acceso Presencial a un evento de TicketHub</li>
                <li class="paquete__elemento">Pase por 1 día</li>
                <li class="paquete__elemento">Acceso a las grabaciones</li>
                <li class="paquete__elemento">Regalo del evento</li>
        ...
        <div class="paquete">
            ...
            <ul class="paquete__lista">
                <li class="paquete__elemento">Acceso Virtual a un evento de TicketHub</li>
                <li class="paquete__elemento">Pase por 1 días</li>
                <li class="paquete__elemento">Acceso a las grabaciones</li>
            </ul>
          ...
          return actions.order.capture().then(function(orderData) {
                ...
                .then(resultado => {
                    if(resultado.resultado) {
                        actions.redirect('https://mozfifa.nyc.dom.my.id/finalizar-registro/conferencias');
                    }
                })
