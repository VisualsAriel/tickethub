...
<div class="barra">
    <div class="barra__contenido">
        ...
        <nav class="navegacion">
            <a href="/tickethub" class="navegacion__enlace <?php echo pagina_actual('/tickethub') ? 'navegacion__enlace--actual' : ''; ?>">Evento</a>
            <a href="/paquetes" class="navegacion__enlace <?php echo pagina_actual('/paquetes') ? 'navegacion__enlace--actual' : ''; ?>">Paquetes</a>
            <a href="/workshops-conferencias" class="navegacion__enlace <?php echo pagina_actual('/workshops-conferencias') ? 'navegacion__enlace--actual' : ''; ?>">Conciertos / Conferencias</a>
