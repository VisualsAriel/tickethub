...
<section class="speakers">
    <h2 class="speakers__heading">Cantantes & Speakers</h2>
    <p class="speakers__descripcion">Conoce a nuestros cantantes que se presentaran</p>
...
<section class="boletos">
    ...
    <p class="boletos__descripcion">Precios para un evento de TicketHub</p>

    <div class="boletos__grid">
        <div <?php aos_animacion(); ?> class="boleto boleto--presencial">
            <h4 class="boleto__logo">TicketHub</h4>
